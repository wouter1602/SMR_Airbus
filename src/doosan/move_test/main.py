...
def main():
    ...
    if success:
        ...
        status_1 = robot.get_digital_output(doosan_drfl.GPIO_CTRLBOX_DIGITAL_INDEX.Index_1)

        print(f"Current status of output 1 is: {status_1}")

        time.sleep(10)

        status = robot.set_digital_output(doosan_drfl.GPIO_CTRLBOX_DIGITAL_INDEX.Index_1, False)
